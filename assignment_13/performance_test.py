...
if __name__ == "__main__":
    # Та өөрийн deploy хийсэн URL-аа энд бичээрэй. Жишээ нь: https://mongolia-travel-planner.onrender.com
    # Эсвэл локал хаяг: http://localhost:3000
    target_url = "https://google.com" 
    print(f"Testing URL: {target_url}")
    tester = PerformanceTester(target_url, num_requests=20, concurrent_users=5)
    tester.run_test()
